...
class Parsedown
{
    ...
    /**
     * Holds all anchors provided in document
     * in order to create a content summary
     */
    protected $contentsSummary;

    /**
     * Loading all available Blocks
     */
    use Blocks\BlockCode;
    use Blocks\BlockComment;
    use Blocks\BlockFencedCode;
    use Blocks\BlockHeader;
    use Blocks\BlockTextHeader;
    use Blocks\BlockList;
    use Blocks\BlockMarkup;
    use Blocks\BlockQuote;
    use Blocks\BlockRule;
    use Blocks\BlockTable;
    use Blocks\BlockCheckInput;

    /**
     * With support for Inline Markdown
     */
    use Inlines\InlineHandler;

    /**
     * Retrieve the content summary collected while parsing document.
     * @return array
     */
    ...
    {
        // Unset previous summary history
        $this->contentsSummary = null;
    ...
    protected function element(array $Element)
    {
        ...
        $permitRawHtml = $this->safeMode === false || $allowRawHtmlInSafeMode;
    ...
    protected function li($lines)
    {
        ...
        if ( ! in_array('', $lines) && isset($Elements[0])
            && isset($Elements[0]['name']) && $Elements[0]['name'] === 'p') {
